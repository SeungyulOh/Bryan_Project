...
BOOL CMainFrame::OnCreateClient(LPCREATESTRUCT lpcs, CCreateContext* pContext)
{
	...
	m_MainSplitter.CreateView(0,1,RUNTIME_CLASS(CMyFormView),CSize(WINCX/2,WINCY),pContext);

	m_pToolView = (CToolView*)m_MainSplitter.GetPane(0,0);
	m_pMyForm = (CMyFormView*)m_MainSplitter.GetPane(0,1);
