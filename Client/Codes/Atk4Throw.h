#ifndef Atk4Throw_h__
#define Atk4Throw_h__
...
class CAtk4Throw : public Engine::CParticleSystem
{
private:
	explicit CAtk4Throw(LPDIRECT3DDEVICE9 pGraphicDev,_int iNumParticles);
	virtual ~CAtk4Throw();
...
public:
	static CAtk4Throw* Create(LPDIRECT3DDEVICE9 pGraphicDev, _int iNumParticles);
